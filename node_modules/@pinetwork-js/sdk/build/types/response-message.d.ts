...
type ResponseMessagePayload<T extends MessageType> = T extends MessageType.COMMUNICATION_INFORMATION_REQUEST ? CommunicationInformationResponsePayload : T extends MessageType.PREPARE_PAYMENT_FLOW ? PreparePaymentFlowResponsePayload : T extends MessageType.START_PAYMENT_FLOW ? StartPaymentFlowResponsePayload : T extends MessageType.WAIT_FOR_TRANSACTION ? WaitForTransactionResponsePayload : T extends MessageType.OPEN_CONSENT_MODAL ? OpenConsentModalResponsePayload : T extends MessageType.CHECK_NATIVE_FEATURES ? CheckNativeFeaturesResponsePayload : T extends MessageType.DECIDE_CALLBACK_RETRIAL ? DecidalCallbackRetrialResponsePayload : T extends MessageType.COPY_TEXT_FROM_TPA ? CopyTextFromTPAResponsePayload : T extends MessageType.REQUEST_NATIVE_PERMISSION ? RequestNativePermissionResponsePayload : T extends MessageType.OPEN_URL_IN_SYSTEM_BROWSER ? OpenUrlInSystemBrowserResponsePayload : T extends MessageType.OPEN_SHARE_DIALOG_ACTION ? OpenShareDialogResponsePayload : T extends MessageType.OPEN_APP_CONVERSATION_WITH_ID ? OpenAppConversationResponsePayload : void;
...
export type ResponseMessage<T extends MessageType> = ResponseMessagePayload<T> extends void ? BaseResponseMessage : Required<BaseResponseMessage> & {
    /**
